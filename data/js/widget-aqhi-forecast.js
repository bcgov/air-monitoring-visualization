...
d3.json('https://csv-parser.api.gov.bc.ca/?source=ftp://ftp.env.gov.bc.ca/pub/outgoing/AIR/Hourly_Raw_Air_Data/Station/' + QueryString + '.csv&format=json', function (err, data) {
    ...
    d3.select(".current-date").html('Latest data at: <strong>' + data[data.length - 1].DATE + '</strong>. Learn more about <a href="#" data-toggle="modal" data-target="#myModal">AQHI Categories and Explanations.</a> and please read our <a href="#data-disclaimer">air quality data disclaimer</a> below.');
