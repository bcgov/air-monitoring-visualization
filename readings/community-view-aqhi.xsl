...
<!-- Daylight savings -->
    ...
    <xsl:choose>
    					<xsl:when test="((substring(READS/RD[1]/@DT,0,5)='2020') and (
...
<!-- RG added October 3, 2017 Special SO2 Message 1 and 2 if conditions met. RT update, no longer required -->
			    			<!-- <xsl:if test="((round(@SO2_GT_36) &gt; 36) and (round(@SO2_GT_36) &lt; 185))"><p><span style="display:block;"><strong>*Elevated levels of SO<sup>2</sup> (sulphur dioxide) have been reported.</strong></span></p></xsl:if>
    <xsl:if test="((round(@SO2_GT_36) &gt; 185))"><p><span style="display:block;"><strong>*Elevated levels of SO<sup>2</sup> (sulphur dioxide) have been reported. </strong></span></p></xsl:if> -->
<!-- end:  Special SO2 Message 1 and 2 if conditions met -->

<!-- Health messaging for current AQHI -->
<div id="healthMessaging">
                            <xsl:choose>
                               <!-- RT added Apr 26, 2019 Special SO2 Message 1 and 2 if conditions met -->
                               <xsl:when test="((round(@SO2_GT_36) &gt; 36)) and ((round(@SO2_GT_36) &lt; 185))">
                                	<p>
                                    <xsl:choose>
                                    ...
                                    &nbsp; Elevated levels of sulphur dioxide have been reported. Persons with chronic respiratory conditions such as asthma should consider reducing or rescheduling strenuous outdoor activities if experiencing symptoms. No effects are expected for the general population. </p>
                                </xsl:when>
                                <xsl:when test="((round(@SO2_GT_36) &gt; 185))">
                                	<p>
                                   <xsl:choose>
	                                	<xsl:when test="round(@AHI_NOW)='1'"><div class="aqhi1 aqhiSquare"></div></xsl:when> 
    		                    		<xsl:when test="round(@AHI_NOW)='2'"><div class="aqhi2 aqhiSquare"></div></xsl:when>
                                    	...
                                    	<xsl:when test="round(@AHI_NOW)='5'"><div class="aqhi5 aqhiSquare"></div></xsl:when>
                                    	<xsl:when test="round(@AHI_NOW)='6'"><div class="aqhi6 aqhiSquare"></div></xsl:when>
                                    	<xsl:when test="round(@AHI_NOW)='7'"><div class="aqhi6 aqhiSquare"></div></xsl:when>                                       
                                    </xsl:choose>
                                    &nbsp; Elevated levels of sulphur dioxide have been reported and have increased the AQHI. Persons with chronic respiratory conditions such as asthma should follow AQHI messaging. No effects are expected for the general population. </p>
                    ...
                    <p><strong>* If the AQHI index has increased to 7 (high health risk), it is usually because of high concentrations of smoke particles (PM2.5) in this community.</strong></p>   
                                ...
                                <xsl:when test="(@AHI_NOW &gt;= '6.5') and (@AHI_NOW &lt; '10.5') and ((round(@SO2_GT_36) &gt; 70))"> 
                                    <p>
                                    <xsl:choose>
	                                	<xsl:when test="round(@AHI_NOW)='7'"><div class="aqhi7 aqhiSquare"></div></xsl:when> 
    		                    		<xsl:when test="round(@AHI_NOW)='8'"><div class="aqhi8 aqhiSquare"></div></xsl:when>
                                    ...
                                    &nbsp; <strong>At risk population SO2</strong>: Reduce or reschedule strenuous activities outdoors. Children and the elderly should also take it easy.</p>
                                    <p>
                                    <xsl:choose>
	                                	<xsl:when test="round(@AHI_NOW)='7'"><div class="aqhi7 aqhiSquare"></div></xsl:when> 
    		                    		<xsl:when test="round(@AHI_NOW)='8'"><div class="aqhi8 aqhiSquare"></div></xsl:when>
                                    ...
                                    &nbsp; <strong>General population SO2</strong>: Consider reducing or rescheduling strenuous activities outdoors if you experience symptoms such as coughing and throat irritation.</p>
