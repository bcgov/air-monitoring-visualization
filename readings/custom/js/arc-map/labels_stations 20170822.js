...
var duncc= new GraphicsLayer();
		...
		new Color([0,0,0])).setFont(labelfont).setAlign(TextSymbol.ALIGN_END).setOffset(-18,-8).setAngle(0);
...
var valec= new GraphicsLayer();
		...
		var valemontcourt =  new TextSymbol("Valemount Courthouse").setColor(
		new Color([0,0,0])).setFont(labelfont).setAlign(TextSymbol.ALIGN_START).setOffset(4,4).setAngle(0);
